...
bg =ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p2.png")
...
tid=my_mcanvas.create_text(505,150, text="WELCOME TO", font=("Helvetica", 32), fill="white")
tid=my_mcanvas.create_text(500,200, text="HALSTONS", font=("Helvetica", 32), fill="white")
ei_entry1,pw_entry1="",""
ei_entry2,pw_entry2="",""
o1,o5=0,0
o2,o3,o4="","",""
...
def admin():
    ...
    bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
    my_canvas.create_image(0,0, image=bg, anchor="nw")
    my_canvas.create_text(500,200, text="ADMINISTRATOR LOGIN", font=("ARIAL", 30), fill="white")
    ...
    def newwin1():
        ...
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
        n1canvas.create_image(0,0, image=bg, anchor="nw")
        n1canvas.create_text(500,50, text="PROFILE", font=("ARIAL", 30), fill="white")
    ...
    def newwin2():
        ...
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
        n2canvas.create_image(0,0, image=bg, anchor="nw")
        new2.configure(bg="lightblue")
        n2canvas.create_text(500,50, text="ORDERS", font=("ARIAL", 30), fill="white")
        def Delete():
            selected = tv.focus()
        ...
        style.configure("Treeview",background="#ADD8E6",foreground="black",rowheight=25,fieldbackground="#ADD8E6")
    ...
    def newwin4():
        ...
        new4.configure(bg="lightblue")
        n4canvas=Canvas(new4, width=1000, height=350)
        n4canvas.pack(fill="both", expand=True)
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
        n4canvas.create_image(0,0, image=bg, anchor="nw")
        n4canvas.create_text(500,50, text="EDIT ELECTRONICS MENU", font=("ARIAL", 30), fill="white")
        ...
        # Configure the Treeview Colors
        style.configure("Treeview",background="#ADD8E6",foreground="black",rowheight=28,fieldbackground="#ADD8E6")
    ...
    def newwin5():
        ...
        new5.configure(bg="lightblue")
        new5.resizable(width=False, height=False)
        n5canvas.pack(fill="both", expand=True)
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
        n5canvas.create_image(0,0, image=bg, anchor="nw")
        n5canvas.create_text(500,50, text="EDIT CLOTHING AND ACCESORIES MENU", font=("ARIAL", 30), fill="white")
    ...
    def newwin6():
        ...
        new6.configure(bg="lightblue")
        new6.resizable(width=False, height=False)
        n6canvas.pack(fill="both", expand=True)
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
        n6canvas.create_image(0,0, image=bg, anchor="nw")
        n6canvas.create_text(500,50, text="EDIT HOMEAPPLIANCE AND FURNITURE MENU", font=("ARIAL", 30), fill="white")
    ...
    def newwina():
        ...
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
        ncanvas.create_image(0,0, image=bg, anchor="nw")
        ncanvas.create_text(500,100, text="MAIN MENU", font=("Helvetica", 30), fill="white")
...
def customer():
    ...
    bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p1.png")
    my_canvas.create_image(0,0, image=bg, anchor="nw")
    my_canvas.create_text(500,200, text="CUSTOMER LOGIN", font=("ARIAL", 30), fill="white")
    ...
    def newwin1():
        ...
        new1.resizable(width=False, height=False)
        n1canvas.pack(fill="both", expand=True)
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p2.png")
        n1canvas.create_image(0,0, image=bg, anchor="nw")
        n1canvas.create_text(500,50, text="PROFILE", font=("ARIAL", 30), fill="white")
    ...
    def newwin2():
        ...
        n2canvas.pack(fill="both", expand=True)
        n2canvas.create_image(0,0, image=bg, anchor="nw")
        n2canvas.create_text(500,50, text="YOUR CART", font=("ARIAL", 30), fill="white")
        global cid
        def Delete():
            global cid
            selected = tv.focus()
        ...
        def bill():
            ...
            n2canvas.create_text(325,200, text=a, font=("ARIAL", 30), fill="white")
        ...
        # Configure the Treeview Colors
        style.configure("Treeview",background="#ADD8E6",foreground="black",rowheight=30,fieldbackground="#ADD8E6")
        ...
        tv.column('#0', width=0, stretch=NO)
        tv.column('OID', anchor=CENTER, width=175)
        tv.column('NAME', anchor=CENTER, width=175)
        tv.column('PRICE', anchor=CENTER, width=175)
    ...
    def newwin4():
        ...
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p2.png")
        n4canvas.create_image(0,0, image=bg, anchor="nw")
        n4canvas.create_text(500,50, text=" ELECTRONICS MENU", font=("ARIAL", 30), fill="white")
        n4canvas.create_text(500,100, text=" CLICK TO VIEW ITEM DETAILS", font=("ARIAL", 30), fill="white")
        def insert_tree():
            mr.execute("select* from electronics")
            rec=mr.fetchall()
            l=[]
        ...
        # Configure the Treeview Colors
        style.configure("Treeview",background="#ADD8E6",foreground="black",rowheight=35,fieldbackground="#ADD8E6")
        ...
        def select_record(e):
            ...
            bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p2.png")
            new41c.create_image(0,0, image=bg, anchor="nw")
            ...
            new41c.create_text(300,150, text=o1, font=("ARIAL", 26), fill="white")
            new41c.create_text(300,190, text=o2, font=("ARIAL", 26), fill="white")
            new41c.create_text(300,230, text=o3, font=("ARIAL", 26), fill="white")
            new41c.create_text(300,270, text=o4, font=("ARIAL", 26), fill="white")
            new41c.create_text(300,310, text=o5, font=("ARIAL", 26), fill="white")
    ...
    def newwin6():
        ...
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p2.png")
        n6canvas.create_image(0,0, image=bg, anchor="nw")
        n6canvas.create_text(500,50, text="HOMEAPPLIANCE AND FURNITURE MENU", font=("ARIAL", 30), fill="white")
        n6canvas.create_text(500,100, text=" CLICK TO VIEW ITEM DETAILS", font=("ARIAL", 30), fill="white")
        def insert_tree():
            mr.execute("select* from homeappliance_and_furniture ")
            rec=mr.fetchall()
            l=[]
        ...
        def select_record(e):
            ...
            new41c.create_text(300,145, text=o1, font=("ARIAL", 20), fill="white")
            new41c.create_text(300,185, text=o2, font=("ARIAL", 20), fill="white")
            new41c.create_text(300,225, text=o3, font=("ARIAL", 20), fill="white")
            new41c.create_text(450,295, text=o4, font=("ARIAL", 20), fill="white")
            new41c.create_text(300,335, text=o5, font=("ARIAL", 20), fill="white")
            cart_btn = Button(new41, text="Add to cart", font=("Arial", 12), width=25, fg="black",command=orders)
    ...
    def signup():
        ...
        bg1=ImageTk.PhotoImage(file ="E:\\CSC XII-A\\Project\\images\\p2.png")
        ncanvas.create_image(0,0, image=bg, anchor="nw")
        ncanvas.create_text(500,70, text="SIGN UP", font=("Helvetica", 30), fill="white")
